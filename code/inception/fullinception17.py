...
class InceptionNet1(nn.Module):
    def __init__(self, dropout=0.5):
        ...
        self.inception3 = InceptionBlock(64, channel2[0], channel2[1], channel2[2], channel2[3], channel2[4],
                                         channel2[5])
        self.inception4 = InceptionBlock(128, channel3[0], channel3[1], channel3[2], channel3[3], channel3[4],
                                         channel3[5])
        self.inception5 = InceptionBlock(192, channel4[0], channel4[1], channel4[2], channel4[3], channel4[4],
                                         channel4[5])
    ...
    def forward(self, x):
        ...
        x = self.sequential(self.inception5(x))
        return x


# 基于full15  准确率过低
class FullInception17(nn.Module):
    def __init__(self, frame, column, output_size, dropout=0.5):
        super(FullInception17, self).__init__()
        self.frame = frame
        self.column = column
