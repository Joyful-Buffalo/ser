...
class InceptionNet1(nn.Module):
    def __init__(self, dropout=0.5):
        ...
        self.inception2 = InceptionBlock(96, channel1[0], channel1[1], channel1[2], channel1[3], channel1[4],
                                         channel1[5])
...
# 采用新head+3inceptionBlock
class FullInception9(nn.Module):
    def __init__(self, frame, column, output_size, dropout=0.5):
        super(FullInception9, self).__init__()
        self.frame = frame
        self.column = column
