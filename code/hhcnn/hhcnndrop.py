...
class HhCnnDrop0(nn.Module):
    def __init__(self, dropout=0.5):
        super(HhCnnDrop0, self).__init__()
...
class HhCnnDrop1(nn.Module):
    def __init__(self, dropout=0.5):
        super(HhCnnDrop1, self).__init__()
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 32, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2)),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
...
class HhCnnDrop2(nn.Module):
    def __init__(self, dropout=0.5):
        super(HhCnnDrop2, self).__init__()
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 32, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2)),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
...
class HhCnnDrop4(nn.Module):
    def __init__(self, dropout=0.5):
        super(HhCnnDrop4, self).__init__()
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 32, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2)),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
